        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromStation = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ToStation = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainUpdates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainUpdates_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainUpdates_CreatedByUserId",
                table: "TrainUpdates",
